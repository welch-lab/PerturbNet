...
if __name__ == "__main__":
	...
	model_train = GenotypeVAETrain(genovae_model=model, device=device)

	model_train.train_np(epochs=40, data_vae_onehot=data_geno_onehot, perturb_with_onehot=perturb_with_onehot_kept,
