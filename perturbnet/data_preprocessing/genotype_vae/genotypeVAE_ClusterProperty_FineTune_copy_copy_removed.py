...
if __name__ == "__main__":
	...
	path_save = 'output_latent10_epoch300_GenotypeVAE_1em4_sumLoss_ClusterPropertyFineTune_lambda10_50removed' 
	# data
	lambda_weight = 10
	...
	data_geno = data_geno[kept_indices]	
	...
	def train(epoch):
		...
		for batch_idx, (batch_anno, batch_prop, indices) in enumerate(train_prop_loader):
			...
			mseLoss = lambda_weight * mse_loss(batch_prop.float().to(device), prop)
