...
import random
import yaml
from .models import load_encoder, load_decoder, load_property_predictor, load_varLayer
import numpy as np
import pandas as pd
import os
...
class VAEUtils(object):
    ...
    def estimate_estandarization(self):
        ...
        self.Z_sample = self.standardize_z(Z_sample)
    ...
    def enc_dec_functions(self, standardized=True):
        ...
        def encode_sample(X, standardize = standardized):
            ...
            z_samp, z_logvar = self.varlayer.predict(mean, middle)
            if standardized:
